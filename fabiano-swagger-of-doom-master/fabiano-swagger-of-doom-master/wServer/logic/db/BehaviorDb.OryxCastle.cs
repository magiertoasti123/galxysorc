    ...
    partial class BehaviorDb
    {
        private _ OryxCastle = () => Behav()
        	...
        	.Init("Oryx Pet",
                ...
                new Threshold(50,
                    new ItemLoot("Lucky Clover", 45.5),
                    new ItemLoot("loot drop potion", 45.5),
                    new ItemLoot("loot tier potion", 45.5),
                    new ItemLoot("XP Booster 1 hr", 45.5),
                    new ItemLoot("loot drop potion", 45.5),
                    new ItemLoot("BackPack", 45.5),
                    new ItemLoot("Strike Amulet", 0.01),
