        ...
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                ...
                new Threshold(0.05,
                    ...
                    new ItemLoot("Lucky Clover", 0.1),
                    new ItemLoot("loot drop potion", 0.1),
                    new ItemLoot("loot tier potion", 0.1),
                    new ItemLoot("XP Booster 1 hr", 0.5),
                    new ItemLoot("loot drop potion", 0.1)
               ),
                new Threshold(0.1,
                    new ItemLoot("Strike Amulet", 0.1),
                    new ItemLoot("Potion of Maxy", 0.1),
                    new ItemLoot("Bow of Deep Enchantment", 0.1),
                    new ItemLoot("Bow of Mystical Energy", 0.1),
                    new ItemLoot("Dagger of Dire Hatred", 0.1),
                    new ItemLoot("Dagger of Sinister Deeds", 0.1),
                    new ItemLoot("Annihilation Armor", 0.1),
                    new ItemLoot("Dominion Armor", 0.1),
                    new ItemLoot("Wyrmhide Armor", 0.1),
                    new ItemLoot("Leviathan Armor", 0.1),
                    new ItemLoot("Thousand Shot", 0.1)
                )
            )
